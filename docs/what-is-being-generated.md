...
NubesGen generates a set of Terraform or Biceps configurations. If you selected the [GitOps option](gitops-overview.md), it will also generate a GitHub Action.
