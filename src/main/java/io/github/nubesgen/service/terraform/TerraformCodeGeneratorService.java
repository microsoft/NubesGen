...
@Service
public class TerraformCodeGeneratorService implements CodeGeneratorService{

    private final Logger log = LoggerFactory.getLogger(TerraformCodeGeneratorService.class);
    ...
    public TerraformCodeGeneratorService(TerraformTemplateListService templateListService) throws IOException {
    ...
    public boolean supports(IaCToolType type) {
        return IaCToolType.TERRAFORM.equals(type);
    }
