package io.github.nubesgen.service.pulumi;
...
import io.github.nubesgen.configuration.AddonType;
...
@Service
public class PulumiCodeGeneratorService implements CodeGeneratorService {

    private final Logger log = LoggerFactory.getLogger(PulumiCodeGeneratorService.class);
    private final PulumiTemplateListService templateListService;
    private final Map<String, Template> templateCache = new HashMap<>();

    public PulumiCodeGeneratorService(PulumiTemplateListService templateListService) throws IOException {
    ...
    @Override
    public boolean supports(IaCToolType type) {
        return IaCToolType.PULUMI.equals(type);
    }
    ...
    private void generateFileList(NubesgenConfiguration configuration, List<String> fileList,
