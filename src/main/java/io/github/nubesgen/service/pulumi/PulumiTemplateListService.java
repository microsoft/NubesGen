...
@Service
public class PulumiTemplateListService {
    ...
    public PulumiTemplateListService() {
        // GitOps files
        gitOpsList.add(".github/workflows/gitops.yml");
        // Main files
        mainList.add("pulumi/.gitignore");
        mainList.add("pulumi/index.ts");
        mainList.add("pulumi/package-lock.json");
        mainList.add("pulumi/package.json");
        mainList.add("pulumi/Pulumi.dev.yaml");
        mainList.add("pulumi/Pulumi.yaml");
        mainList.add("pulumi/tsconfig.json");
        // App Service module
