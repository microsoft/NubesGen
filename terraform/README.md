...
```
curl "http://localhost:8080/nubesgen.tgz?iactool=TERRAFORM&region=westeurope&application=CONTAINER_APPS&runtime=DOCKER&database=NONE.free&addons=storage_blob&gitops=true" | tar -xzvf -
```
